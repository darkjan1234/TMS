    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        <h4 class="title" style="text-align: center;">Drivers Information</h4>
                    </div>
                    <?php if (get("success")) : ?>
                        <div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="offence_id" class="form-control" placeholder="Offense ID"
                                            value="<?php $prefix = md5(time() * rand(1, 2));
...
$result = $db->prepare("SELECT id, username, email, name, address, contact, fines FROM user WHERE id='$user'");
$result->execute();
    ...
    ?>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="officer_reporting" class="form-control"
                                            placeholder="Officer Name" value="<?php echo $row['username']; ?>" readonly>
                                    </div>
                                </div>
                                <?php } ?>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="offence">
                                            ...
                                            <option value="Attempting to corrupt Marshall on duty">Attempting to
                                                corrupt Marshall on duty</option>
                                            ...
                                            <option value="Driving Under Drug Influence">Driving Under Drug Influence
                                            </option>
                                            <option value="Driving with worn out tires">Driving with worn out tires
                                            </option>
                                            <option value="Constantly caught for No seatbelt">Constantly caught for
                                                No seatbelt</option>
                                            <option value="Excessive smoke emission">Excessive smoke emission</option>
                                            <option value="Failure to fix red flag on projected load">Failure to fix
                                                red flag on projected load</option>
                                            <option value="Fire extinguisher violation">Fire extinguisher violation</option>
                                            <option value="No Caution">No Caution</option>
                                            <option value="Holding with forged documents">Holding with forged
                                                documents</option>
                                            <option value="Riding Motorcycle without crash helmet">Riding
                                                Motorcycle without crash helmet</option>
                                            ...
                                            <option value="Making calls while driving">Making calls while driving
                                            </option>
                                            <option value="Other offenses and violations">Other offenses and
                                                violations</option>
                                        </select>
                                    </div>
                                </div>
